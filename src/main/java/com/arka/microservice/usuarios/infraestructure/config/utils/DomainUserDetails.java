...
/**
 * Esta clase actúa como un "adaptador" que transforma la información almacenada en la
 * entidad User a un formato que Spring Security utiliza internamente durante
